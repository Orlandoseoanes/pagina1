...
}, "C:/Users/Jailer/Desktop/pagina1/src/layouts/Layout.astro", void 0);
...
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Cardindex.astro", void 0);
...
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Navbar.astro", void 0);
...
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Botonbanner.astro", void 0);
...
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Hero.astro", void 0);

const $$Astro$6 = createAstro();
const $$Hero2 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$6, $$props, $$slots);
  Astro2.self = $$Hero2;
  return renderTemplate`${maybeRenderHead()}<div class="hero w-full bg-base-100" data-astro-cid-glk5rbbc> <div class="hero-content flex-col lg:flex-row" data-astro-cid-glk5rbbc> <img src="/Photo.png" class="w-full md:w-1/2" data-astro-cid-glk5rbbc> <div class="w-full" data-astro-cid-glk5rbbc> <h1 class="text-3xl text-secondary" data-astro-cid-glk5rbbc>About us</h1> <p class="py-6 text-primary text-5xl font-bold" data-astro-cid-glk5rbbc>We Believe in Working <br data-astro-cid-glk5rbbc> Accredited Farmers</p> <p class="text-xl" data-astro-cid-glk5rbbc>
Simply dummy text of the printing and typesetting industry. Lorem had
        ceased to been the industry's standard dummy text ever since the 1500s,
        when an unknown printer took a galley.
</p> <div class="w-full md:w-1/2" data-astro-cid-glk5rbbc> <div class="flex p-2 w-full gap-2" data-astro-cid-glk5rbbc> <div data-astro-cid-glk5rbbc> <img src="/Icon.png" class="max-w-lg rounded-lg shadow-2xl" data-astro-cid-glk5rbbc> </div> <div class="" data-astro-cid-glk5rbbc> <p class="text-primary font-bold text-2xl" data-astro-cid-glk5rbbc>Organic Foods Only</p> <p class="text-lg" data-astro-cid-glk5rbbc>Simply dummy text of the printing and typesetting <br data-astro-cid-glk5rbbc> industry. Lorem Ipsum</p> </div> </div> <div class="flex p-2 gap-2" data-astro-cid-glk5rbbc> <div data-astro-cid-glk5rbbc> <img src="/Icon.png" class="max-w-lg rounded-lg shadow-2xl" data-astro-cid-glk5rbbc> </div> <div data-astro-cid-glk5rbbc> <p class="text-primary font-bold text-2xl" data-astro-cid-glk5rbbc>Quality Standards</p> <p class="text-lg" data-astro-cid-glk5rbbc>Simply dummy text of the printing and typesetting industry. Lorem Ipsum</p> </div> </div> </div> <div class="w-full flex justify-center md:justify-start mt-5" data-astro-cid-glk5rbbc><button class="btn md:btn-lg btn-xs btn-primary" data-astro-cid-glk5rbbc>shop now</button></div> </div> </div> </div> `;
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Hero2.astro", void 0);
...
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Menu.astro", void 0);

const $$Astro$3 = createAstro();
const $$Hero3 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$3, $$props, $$slots);
  Astro2.self = $$Hero3;
  return renderTemplate`${maybeRenderHead()}<div class="hero w-full min-h-screen" style="background-image: url(/Background.png);" data-astro-cid-plylcsvu> <div class="hero-content text-center text-neutral-content" data-astro-cid-plylcsvu> <div class="w-full" data-astro-cid-plylcsvu> <h1 class="mb-5 text-5xl text-secondary" data-astro-cid-plylcsvu>Testimonial</h1> <h3 class="mb-5 text-4xl font-bold text-primary" data-astro-cid-plylcsvu>What Our Customer Saying?</h3> <div class="avatar" data-astro-cid-plylcsvu> <div class="w-24 rounded-full" data-astro-cid-plylcsvu> <img src="https://daisyui.com/images/stock/photo-1534528741775-53994a69daeb.jpg" data-astro-cid-plylcsvu> </div> </div> <br data-astro-cid-plylcsvu> <div class="rating rating-sm" data-astro-cid-plylcsvu> <input type="radio" name="rating-6" class="mask mask-star-2 bg-orange-400" checked data-astro-cid-plylcsvu> <input type="radio" name="rating-6" class="mask mask-star-2 bg-orange-400" checked data-astro-cid-plylcsvu> <input type="radio" name="rating-6" class="mask mask-star-2 bg-orange-400" checked data-astro-cid-plylcsvu> <input type="radio" name="rating-6" class="mask mask-star-2 bg-orange-400" checked data-astro-cid-plylcsvu> <input type="radio" name="rating-6" class="mask mask-star-2 bg-orange-400" checked data-astro-cid-plylcsvu> </div> <p data-astro-cid-plylcsvu>
Simply dummy text of the printing and typesetting industry. Lorem Ipsum
        simply dummy text of the printing and typesetting industry. Lorem Ipsum
        has been.
</p> <h2 class="text-primary text-xl font-bold" data-astro-cid-plylcsvu>Sara taylor</h2> <p class="text-primary text-lg" data-astro-cid-plylcsvu>Consumer</p> <hr data-astro-cid-plylcsvu> <br data-astro-cid-plylcsvu> <div class="flex gap-2 w-full justify-center items-center flex-wrap" data-astro-cid-plylcsvu> <div class="avatar placeholder p-2" data-astro-cid-plylcsvu> <div class="bg-base-100 text-neutral-content rounded-full w-32 flex flex-col ring ring-secondary ring-offset-white ring-offset-2" data-astro-cid-plylcsvu> <span class="text-3xl font-bold text-primary" data-astro-cid-plylcsvu>100%</span> <span class="text-xl text-primary" data-astro-cid-plylcsvu>Organic</span> </div> </div> <div class="avatar placeholder p-2" data-astro-cid-plylcsvu> <div class="bg-base-100 text-neutral-content rounded-full w-32 flex flex-col ring ring-secondary ring-offset-white ring-offset-2" data-astro-cid-plylcsvu> <span class="text-3xl font-bold text-primary" data-astro-cid-plylcsvu>285</span> <span class="text-xl text-primary" data-astro-cid-plylcsvu>Active product</span> </div> </div> <div class="avatar placeholder p-2" data-astro-cid-plylcsvu> <div class="bg-base-100 text-neutral-content rounded-full w-32 flex flex-col ring ring-secondary ring-offset-white ring-offset-2" data-astro-cid-plylcsvu> <span class="text-3xl font-bold text-primary" data-astro-cid-plylcsvu>350+</span> <span class="text-xl text-primary" data-astro-cid-plylcsvu>Organic Orchads</span> </div> </div> </div> </div> </div> </div> `;
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Hero3.astro", void 0);

const $$Astro$2 = createAstro();
const $$Card3 = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$2, $$props, $$slots);
  Astro2.self = $$Card3;
  return renderTemplate`${maybeRenderHead()}<div class="rounded-lg mt-4 flex justify-center items-center flex-col"> <div class="relative h-full"> <img class="rounded-lg w-full h-full " src="/Image (4).png" alt=""> <div class="absolute inset-0 flex justify-center items-center"> <div class="flex flex-col md:flex-row items-center md:justify-around justify-center  w-full"> <div class="w-full md:w-1/2 text-center flex justify-center"> <h1 class="text-center font-bold text-white  text-xl break-all md:text-4xl">Subscribe to  our Newsletter</h1> </div> <div class="flex items-center justify-center gap-2 w-full md:w-1/2"> <input type="text" placeholder="Type here" class="input  md:input-lg input-xs  	 input-bordered w-1/2 "> <button class="btn md:btn-lg	 btn-xs	 btn-primary ">Subscribe</button> </div> </div> </div> </div> </div>`;
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Card3.astro", void 0);

const $$Astro$1 = createAstro();
const $$Footer = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$Footer;
  return renderTemplate`${maybeRenderHead()}<footer class="flex justify-around flex-col md:flex-row  gap-5 items-center p-4 md:p-8 bg-base-100 text-base-content w-full"> <nav class="flex flex-col justify-center items-start"> <h1 class="text-4xl text-primary font-bold">Contact us</h1> <h6 class="footer-title self-start mt-3">Email</h6> <a class="link link-hover">needhelp@Organia.com</a> <a class="footer-title self-start mt-3">Phone</a> <a class="link link-hover">666 888 888</a> <a class="footer-title self-start mt-3">Addres</a> <a class="link link-hover">88 road, borklyn street, USA</a> </nav> <nav class="flex flex-col justify-center items-center"> <img src="/Logo (1).png" class="mx-auto"> <br> <p class="text-center text-neutral text-xl">
...
}, "C:/Users/Jailer/Desktop/pagina1/src/components/Footer.astro", void 0);

const $$Astro = createAstro();
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Organick" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="container mx-auto px-4"> ${renderComponent($$result2, "Navbar", $$Navbar, {})} ${renderComponent($$result2, "Hero", $$Hero, {})} <div class="flex flex-wrap mb-4"> ${renderComponent($$result2, "Cardindex", $$Cardindex, { "imagenes": "/Image (2).png", "minititulo": "Natural!!", "descripcion": "Get Garden Fresh Fruits", "clasesPersonalizada1": "text-white", "clasesPersonalizada2": "text-white" })} ${renderComponent($$result2, "Cardindex", $$Cardindex, { "imagenes": "/Image (3).png", "minititulo": "Offer!!", "descripcion": "Get 10% off  on Vegetables", "clasesPersonalizada1": "text-secondary", "clasesPersonalizada2": "text-primary" })} </div> ${renderComponent($$result2, "Hero2", $$Hero2, {})} ${renderComponent($$result2, "Menu", $$Menu, {})} <div class="w-full flex justify-center items-center"> ${renderComponent($$result2, "Hero3", $$Hero3, {})} </div> ${renderComponent($$result2, "Card3", $$Card3, {})} ${renderComponent($$result2, "Footer", $$Footer, {})} </main> ` })} `;
}, "C:/Users/Jailer/Desktop/pagina1/src/pages/index.astro", void 0);

const $$file = "C:/Users/Jailer/Desktop/pagina1/src/pages/index.astro";
const $$url = "";
