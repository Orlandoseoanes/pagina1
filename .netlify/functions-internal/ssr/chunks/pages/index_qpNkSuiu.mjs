...
const $$Hero2 = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Hero2;
  return renderTemplate`${maybeRenderHead()}<div class="hero w-full bg-base-100" data-astro-cid-glk5rbbc> <div class="hero-content flex-col lg:flex-row" data-astro-cid-glk5rbbc> <img src="/Photo.png" class="w-full md:w-1/2" data-astro-cid-glk5rbbc> <div data-astro-cid-glk5rbbc> <h1 class="text-3xl text-secondary" data-astro-cid-glk5rbbc>About us</h1> <p class="py-6 text-primary text-5xl font-bold" data-astro-cid-glk5rbbc>We Believe in Working <br data-astro-cid-glk5rbbc> Accredited Farmers</p> <p class="text-xl" data-astro-cid-glk5rbbc>
